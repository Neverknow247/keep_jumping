...
@onready var kid_zombie = $npcs/child_zombie_controller/kid_zombie
...
func _on_halloween_1_items_finish_kid_zombie_quest():
	kid_zombie.progression = 1
	$npcs/child_zombie_controller.progression = 0

func _on_child_zombie_controller_finished_kid_zombie_quest():
	stats["save_data"]["zombie_progression"] = 1
	SaveAndLoad.update_save_data()
