...
func _unhandled_input(event):
	if (event.is_action_pressed("ui_cancel")||event.is_action_pressed("controller_action")) and !volume_menu.visible and !keybinding_menu.visible and !general_menu.visible and active:
